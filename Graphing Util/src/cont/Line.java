...
public class Line {
    ...
    //finds the y coordinate on a line given the x coordinate
    public double findPoint(double x) {
        double y = _function.apply(x);
        return y;
    }

    //Places the specifics of a line in a label for the gui
    ...
    //Creates a y coordinate given an x coordinate based on a given function
